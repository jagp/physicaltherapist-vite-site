// WIP: Responsive version of Home.tsx — stashed alongside responsive-redesign-wip
// Restore this file over Home.tsx when picking up the responsive work.
// Pop both stashes: git stash pop (this file), then git stash pop (other 7 files).
...
function Hero() {
  ...
  return (
    <section style={{ position: 'relative', overflow: 'hidden', background: 'var(--cream)' }}>
      <div style={{ maxWidth: 'var(--maxw)', margin: '0 auto', padding: '64px var(--gutter) 80px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: isTablet ? '1fr' : '1.05fr .95fr', gap: isTablet ? '36px' : '54px', alignItems: 'center' }}>
    ...
    <section style={{ padding: 'var(--section-pad) 0', background: 'var(--bg)' }}>
      <div style={{ maxWidth: 'var(--maxw)', margin: '0 auto', padding: '0 var(--gutter)' }}>
        <SectionHead
          ...
          light
        />
        <div className="svc-dark" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '22px' }}>
          {services.map((s) => (
            <ServiceCard
              key={s.slug}
              icon={s.icon}
...
function Bio() {
  ...
  return (
    <section style={{ padding: 'var(--section-pad) 0 60px', background: 'var(--bg)' }}>
      <div style={{ maxWidth: 'var(--maxw)', margin: '0 auto', padding: '0 var(--gutter)' }}>
        <div style={{ display: 'grid', gridTemplateColumns: isTablet ? '1fr' : '.85fr 1.15fr', gap: isTablet ? '32px' : '50px', alignItems: 'center' }}>
...
function WCSCallout() {
  ...
  return (
    <section style={{ background: 'var(--bg)', padding: '0 0 var(--section-pad)' }}>
      <div style={{ maxWidth: 'var(--maxw)', margin: '0 auto', padding: '0 var(--gutter)' }}>
        <div
          style={{
...
function Philosophy() {
  ...
  return (
    <section style={{ padding: 'var(--section-pad) 0', background: 'var(--surface-tint)' }}>
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: '0 var(--gutter)', display: 'flex', alignItems: 'center', gap: isTablet ? '32px' : '56px' }}>
        <img
          src={leafMark}
          alt=""
          aria-hidden="true"
          style={{ width: isTablet ? '110px' : '180px', flexShrink: 0, opacity: 0.9, display: isMobile ? 'none' : 'block' }}
        />
        <div>
...
function BookSpotlight() {
  ...
  return (
    <section style={{ padding: '88px 0', background: 'var(--brand-gradient-spicy)' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 var(--gutter)', display: 'grid', gridTemplateColumns: isTablet ? '1fr' : 'auto 1fr', gap: isTablet ? '28px' : '48px', alignItems: 'center' }}>
        <div
          style={{
            width: '160px',
            aspectRatio: '3/4',
