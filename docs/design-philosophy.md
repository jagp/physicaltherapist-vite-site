...
23. **Stack your best trust elements high.** Above the fold or just below, surface exactly three: top credential (Board-Certified PWCS), an institution marker (Brigham/MGH), and one short patient quote. Users spend most of their attention above the fold.
...
25. **Credibility as a "badge of honor" block.** A dedicated, understated section for credentials/authority (PWCS explainer, author of the Routledge text, international teaching, GWHI). This is her core differentiator — give it room, keep it factual, not boastful.
